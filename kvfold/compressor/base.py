...
class CompressorStats:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Adds the derived ``compression_ratio`` for convenience.
        """
        return {
    ...
    def compression_ratio(self) -> float:
        ...
        Returns ``1.0`` if the compressed size is zero (i.e. no
        compression happened); never raises on divide-by-zero.
        """
