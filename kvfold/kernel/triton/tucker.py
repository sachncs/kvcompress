...
def try_compile_triton():
    ...
    def tucker_reconstruct_kernel(
        ...
        # Fused Tucker reconstruction kernel.
        # Computes X̂[m, t, d] = Σ_{rt, rd} core[m, rt, rd] · U_T[t, rt] · U_d[d, rd]
        # in a single fused kernel. Grid: (m, T, d) one program per output cell.
        # Tile sizes BLOCK_RT / BLOCK_RD are compile-time constants; the
        # outer accumulation is reduced to a single rank-tile at a time.
